# Generated by Django 3.2.7 on 2021-10-06 22:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comprobanteCDR', models.URLField(db_column='cdr')),
                ('pedido', models.OneToOneField(db_column='pedido_id', on_delete=django.db.models.deletion.CASCADE, related_name='pedidoComprobante', to='cms.pedidomodel')),
            ],
            options={
