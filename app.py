# from models.usuario import UsuarioModel  => Creación tabla Usuario
# from models.tarea import TareaModel => Creación tabla Tarea 
...
# base_de_datos.drop_all(app=app) => Borra tablas
...
# api.add_resource(LoginController, '/login') => Login de prueba. 
